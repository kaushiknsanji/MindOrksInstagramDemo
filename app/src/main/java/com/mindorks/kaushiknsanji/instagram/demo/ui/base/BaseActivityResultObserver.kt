 ...
 *
 * @param T The type of [BaseActivity] registering this Lifecycle observer for activity results.
 ...
 */
abstract class BaseActivityResultObserver<T : BaseActivity<out BaseViewModel>>(
     ...
     * [androidx.activity.result.ActivityResultLauncher]s for the Activity.
     *
